...
Different machine learning models employ distinct methodologies for calculating feature importance(s) and this can lead to varying degrees of bias. Feature importances from machine learning models are always inherently biased which is not a trivial issue. While machine learning target predictions possess ground truth values for accuracy validation, feature importances from models do not possess ground truth values for accuracy validation.
